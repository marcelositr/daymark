...
void main() {
  ...
  test(
    'Future Log entries and Task state persist across lock and unlock',
    () async {
      final JournalSession created = await manager.create(
        masterPassword: 'persistent future journal',
      );
      final FutureLogSnapshot initial = await created.loadFutureLog(
        '2026-10-01',
      );
      ...
      final FutureLogSnapshot captured = await created.loadFutureLog(
        '2026-10-01',
      );
      ...
      final FutureLogSnapshot loaded = await reopened.loadFutureLog(
        '2026-10-01',
      );
