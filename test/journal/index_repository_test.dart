...
void main() {
  ...
  test(
    'preserves deliberate Index insertion order across target types',
    () async {
  ...
  test('candidates exclude structures already present in the Index', () async {
    ...
    final String collectionId = await service.createCollection(title: 'Trip');
  ...
  test(
    'rejects duplicate and unknown targets without partial Index rows',
    () async {
      final String collectionId = await service.createCollection(
        title: 'Reading',
      );
